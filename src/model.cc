...
namespace flu 
{
            ...
            const Eigen::MatrixXi &school_rate )
    {
        ...
        while (step_count<cases.times.size())
        {
            ...
            transmission_regular2(0, 0) = transmission_regular2(0, 0) * school_rate(step_count, 0);
            transmission_regular2(1, 1) = transmission_regular2(1, 1) * school_rate(step_count, 1);
