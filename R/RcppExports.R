...
.inference_cpp <- function(demography, age_group_limits, ili, mon_pop, n_pos, n_samples, vaccine_calendar, polymod_data, initial, mapping, risk_ratios, epsilon_index, psi_index, transmissibility_index, susceptibility_index, initial_infected_index, lprior, pass_prior, lpeak_prior, pass_peak, no_age_groups, no_risk_groups, uk_prior, school_rate, nburn = 0L, nbatch = 1000L, blen = 1L, abs_err = 1e-5) {
    .Call('_fluEvidenceSynthesis_inference_cpp', PACKAGE = 'shinfluevidence', demography, age_group_limits, ili, mon_pop, n_pos, n_samples, vaccine_calendar, polymod_data, initial, mapping, risk_ratios, epsilon_index, psi_index, transmissibility_index, susceptibility_index, initial_infected_index, lprior, pass_prior, lpeak_prior, pass_peak, no_age_groups, no_risk_groups, uk_prior, school_rate, nburn, nbatch, blen, abs_err)
}
...
dmultinom.cpp <- function(x, size, prob, use_log = FALSE) {
    .Call('_fluEvidenceSynthesis_dmultinomialCPP', PACKAGE = 'shinfluevidence', x, size, prob, use_log)
}
...
.updateMeans <- function(means, v, n) {
    .Call('_fluEvidenceSynthesis_updateMeans', PACKAGE = 'shinfluevidence', means, v, n)
}
...
.updateCovariance <- function(cov, v, means, n) {
    .Call('_fluEvidenceSynthesis_updateCovariance', PACKAGE = 'shinfluevidence', cov, v, means, n)
}
...
getTimeFromWeekYear <- function(week, year) {
    .Call('_fluEvidenceSynthesis_getTimeFromWeekYear', PACKAGE = 'shinfluevidence', week, year)
}
...
.infection.model <- function(age_sizes, vaccine_calendar, polymod_data, susceptibility, transmissibility, init_pop, infection_delays, interval = 1L) {
    .Call('_fluEvidenceSynthesis_runSEIRModel', PACKAGE = 'shinfluevidence', age_sizes, vaccine_calendar, polymod_data, susceptibility, transmissibility, init_pop, infection_delays, interval)
}
...
infectionODEs.cpp <- function(population, initial_infected, vaccine_calendar, contact_matrix, susceptibility, transmissibility, infection_delays, dates) {
    .Call('_fluEvidenceSynthesis_infectionODEs', PACKAGE = 'shinfluevidence', population, initial_infected, vaccine_calendar, contact_matrix, susceptibility, transmissibility, infection_delays, dates)
}
...
.log_likelihood_cases <- function(epsilon, psi, predicted, population_size, ili_cases, ili_monitored, confirmed_positive, confirmed_samples) {
    .Call('_fluEvidenceSynthesis_log_likelihood', PACKAGE = 'shinfluevidence', epsilon, psi, predicted, population_size, ili_cases, ili_monitored, confirmed_positive, confirmed_samples)
}
...
log_likelihood_cases <- function(epsilon, psi, predicted, population_size, ili_cases, ili_monitored, confirmed_positive, confirmed_samples, abs_err = 1e-5) {
    .Call('_fluEvidenceSynthesis_total_log_likelihood', PACKAGE = 'shinfluevidence', epsilon, psi, predicted, population_size, ili_cases, ili_monitored, confirmed_positive, confirmed_samples, abs_err)
}
...
.runRKF <- function(step_size = 0.1, h_step = 0.01) {
    .Call('_fluEvidenceSynthesis_runPredatorPrey', PACKAGE = 'shinfluevidence', step_size, h_step)
}
...
.runStep <- function(step_size = 0.1, h_step = 1e-5) {
    .Call('_fluEvidenceSynthesis_runPredatorPreySimple', PACKAGE = 'shinfluevidence', step_size, h_step)
}
...
adaptive.mcmc.cpp <- function(lprior, llikelihood, outfun, acceptfun, nburn, initial, nbatch, blen = 1L, verbose = FALSE) {
    .Call('_fluEvidenceSynthesis_adaptiveMCMCR', PACKAGE = 'shinfluevidence', lprior, llikelihood, outfun, acceptfun, nburn, initial, nbatch, blen, verbose)
}
...
.adaptive.mcmc.proposal <- function(lprior, llikelihood, outfun, acceptfun, nburn, means, covariance, covariance_weight, nbatch, blen = 1L, verbose = FALSE) {
    .Call('_fluEvidenceSynthesis_adaptiveMCMCRCovariance', PACKAGE = 'shinfluevidence', lprior, llikelihood, outfun, acceptfun, nburn, means, covariance, covariance_weight, nbatch, blen, verbose)
}
...
contact_matrix <- function(polymod_data, demography, age_group_limits = as.numeric( c(             1, 5, 15, 25, 45, 65 ))) {
    .Call('_fluEvidenceSynthesis_contact_matrix', PACKAGE = 'shinfluevidence', polymod_data, demography, age_group_limits)
}
...
age_group_levels <- function(limits = as.numeric( c())) {
    .Call('_fluEvidenceSynthesis_age_group_levels', PACKAGE = 'shinfluevidence', limits)
}
...
age_group_limits <- function(levels) {
    .Call('_fluEvidenceSynthesis_age_group_limits', PACKAGE = 'shinfluevidence', levels)
}
...
as_age_group <- function(age, limits = as.numeric( c(             1, 5, 15, 25, 45, 65 ))) {
    .Call('_fluEvidenceSynthesis_as_age_group', PACKAGE = 'shinfluevidence', age, limits)
}
...
stratify_by_age <- function(age_sizes, limits = as.numeric( c(             1, 5, 15, 25, 45, 65 ))) {
    .Call('_fluEvidenceSynthesis_separate_into_age_groups', PACKAGE = 'shinfluevidence', age_sizes, limits)
}
...
.stratify_by_risk <- function(age_groups, risk_ratios, no_risk_groups) {
    .Call('_fluEvidenceSynthesis_stratify_by_risk', PACKAGE = 'shinfluevidence', age_groups, risk_ratios, no_risk_groups)
}
...
as_R0 <- function(transmission_rate, contact_matrix, age_groups, duration = 1.8) {
    .Call('_fluEvidenceSynthesis_as_R0', PACKAGE = 'shinfluevidence', transmission_rate, contact_matrix, age_groups, duration)
}
...
as_transmission_rate <- function(R0, contact_matrix, age_groups, duration = 1.8) {
    .Call('_fluEvidenceSynthesis_as_transmission_rate', PACKAGE = 'shinfluevidence', R0, contact_matrix, age_groups, duration)
}
...
.testRMultinormal <- function(mean, cov) {
    .Call('_fluEvidenceSynthesis_testRMultinormal', PACKAGE = 'shinfluevidence', mean, cov)
}
...
vaccinationScenario <- function(age_sizes, vaccine_calendar, polymod_data, contact_ids, parameters) {
    .Call('_fluEvidenceSynthesis_vaccinationScenario', PACKAGE = 'shinfluevidence', age_sizes, vaccine_calendar, polymod_data, contact_ids, parameters)
}
