---
title: "Using sh_influ_synthesis to infer epidemological parameters."
...
This vignette will focus on how the sh_influ_synthesis package can be used to perform the first step of parameter inference.
